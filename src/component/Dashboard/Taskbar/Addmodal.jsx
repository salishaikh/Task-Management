  ...
  return (
    <>
      <button
        ...
        className="block w-[10rem] text-white bg-[#3a90f6] hover:bg-gradient-to-r from-cyan-500 to-blue-500 duration-500 ease-in-out   focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 "
        type="button"
      >
        Add Task
      </button>
